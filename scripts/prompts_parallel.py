...
If you decide to take an action to interact with smartphone, you can call the following four functions to interact with those labeled elements to control the smartphone:
